...
Création d'un anticheat
Ordre des niveaux. DA des niveaux. 
Flags et minijeux. Zones de hotpoints



Le projet est une création originale réalisée par nous 4. On s'est inspiré des backrooms mais nous n'avons plagié personne. Nous avons eu recours a l'Intelligence Artifielle de l'ordre de 50% environ car il reste des points sur lesquels nous ne sommes pas des experts donc l'IA nous a aidé sur des fonctions et un peu de réalisation du projet et sur des videos et images. Elle nous a aussi aidé a réaliser l'anticheat.